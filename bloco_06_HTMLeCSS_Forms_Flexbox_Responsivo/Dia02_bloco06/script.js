...
function completeInfo() {
    ...
    let data = Object.fromEntries(new FormData(form).entries('form')); // Source - https://stackoverflow.com/questions/2276463/how-can-i-get-form-data-with-javascript-jquery
